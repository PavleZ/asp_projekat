    ...
    public class JwtManager
    {
        ...
        public string MakeToken(string username, string password)
        {
            var user = _context.Users.Include(u => u.UserUseCases)
                .FirstOrDefault(x => x.Username == username && x.Password == Utilities_Helper.MD5(password));
            ...
            var claims = new List<Claim> 
            {
                ...
                new Claim(JwtRegisteredClaimNames.Iss, "blog_api", ClaimValueTypes.String, _issuer),
